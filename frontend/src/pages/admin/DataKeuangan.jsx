...
<div className="flex space-x-2">
  ...
  >
    ...
    Word
      ...
      {/* ========== MODAL FORM UNTUK CREATE/EDIT PEMAKAIAN ========== */}
{showPemakaianModal && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center text-xs">
              ...
              <span className="text-orange-600 font-medium">
                Saldo: {formatCurrency(summaryData?.saldoSyahriah || 0)}
              </span>
            </div>
          </div>
          <input
            ...
            min="0"
            step="0.01"
            max={summaryData?.saldoSyahriah || 0}
            className={`w-full px-3 py-2 border ${
              parseFloat(formData.nominal_syahriah) > (summaryData?.saldoSyahriah || 0)
          ...
          <div className="flex justify-between text-xs mt-1">
            <span className={parseFloat(formData.nominal_syahriah) > (summaryData?.saldoSyahriah || 0) 
              ? 'text-red-600 font-medium' 
              : 'text-orange-500'
            }>
              {parseFloat(formData.nominal_syahriah) > (summaryData?.saldoSyahriah || 0) 
                ? `❌ Melebihi saldo tersedia!`
                : `Sisa: ${formatCurrency((summaryData?.saldoSyahriah || 0) - (parseFloat(formData.nominal_syahriah) || 0))}`
              }
            </span>
            <span className="text-gray-500">
              Maks: {formatCurrency(summaryData?.saldoSyahriah || 0)}
            </span>
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center text-xs">
              ...
              <span className="text-purple-600 font-medium">
                Saldo: {formatCurrency(summaryData?.saldoDonasi || 0)}
              </span>
            </div>
          </div>
          <input
            ...
            min="0"
            step="0.01"
            max={summaryData?.saldoDonasi || 0}
            className={`w-full px-3 py-2 border ${
              parseFloat(formData.nominal_donasi) > (summaryData?.saldoDonasi || 0)
                ? 'border-red-500 bg-red-50'
                : 'border-gray-300'
          ...
          />
          <div className="flex justify-between text-xs mt-1">
            <span className={parseFloat(formData.nominal_donasi) > (summaryData?.saldoDonasi || 0) 
              ? 'text-red-600 font-medium' 
              : 'text-purple-500'
            }>
              {parseFloat(formData.nominal_donasi) > (summaryData?.saldoDonasi || 0) 
                ? `❌ Melebihi saldo tersedia!`
                : `Sisa: ${formatCurrency((summaryData?.saldoDonasi || 0) - (parseFloat(formData.nominal_donasi) || 0))}`
              }
            </span>
            <span className="text-gray-500">
              Maks: {formatCurrency(summaryData?.saldoDonasi || 0)}
            </span>
          </div>
        </div>
        ...
        <div className="md:col-span-2">
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h4 className="text-sm font-medium text-gray-700 mb-2">Informasi Saldo Tersedia</h4>
              ...
              <div className="bg-orange-50 p-3 rounded border border-orange-100">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-orange-700">Dana Syahriah</span>
                  </div>
                  <span className="text-lg font-bold text-orange-800">
                    {formatCurrency(summaryData?.saldoSyahriah || 0)}
                  </span>
                </div>
              </div>
              <div className="bg-purple-50 p-3 rounded border border-purple-100">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-purple-700">Dana Donasi</span>
                  </div>
                  <span className="text-lg font-bold text-purple-800">
                    {formatCurrency(summaryData?.saldoDonasi || 0)}
                  </span>
                </div>
              </div>
            </div>
            <div className="mt-3 pt-3 border-t border-gray-200">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Total Saldo Tersedia:</span>
                <span className="text-lg font-bold text-green-700">
                  {formatCurrency((summaryData?.saldoSyahriah || 0) + (summaryData?.saldoDonasi || 0))}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-2">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="text-xs">
              {parseFloat(formData.nominal_total) > (summaryData?.saldoAkhir || 0) ? (
                <span className="text-red-600 font-medium flex items-center">
                  <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Melebihi total saldo tersedia!
                </span>
              ) : (
                <span className="text-green-600 font-medium">
                  Sisa saldo: {formatCurrency((summaryData?.saldoAkhir || 0) - (parseFloat(formData.nominal_total) || 0))}
                </span>
              )}
            </div>
          </div>
          <input
            ...
            } rounded-lg text-gray-700 cursor-not-allowed`}
            placeholder="0"
          />
          <div className="flex justify-between text-xs mt-1">
            <span className="text-gray-500">
            ...
            <span className="text-gray-500">
              Maks: {formatCurrency(summaryData?.saldoAkhir || 0)}
            </span>
          </div>
        </div>
        ...
        <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
          <div className="flex items-center">
            ...
            <span className="text-red-700 text-sm font-medium">
              ⚠️ Peringatan: Pengeluaran melebihi saldo tersedia!
            </span>
          </div>
          <ul className="mt-2 space-y-1 text-sm text-red-600 ml-7">
            {parseFloat(formData.nominal_syahriah) > (summaryData?.saldoSyahriah || 0) && (
              <li>• Dana Syahriah melebihi saldo tersedia</li>
            )}
            {parseFloat(formData.nominal_donasi) > (summaryData?.saldoDonasi || 0) && (
              <li>• Dana Donasi melebihi saldo tersedia</li>
            )}
            {parseFloat(formData.nominal_total) > (summaryData?.saldoAkhir || 0) && (
              <li>• Total pengeluaran melebihi total saldo</li>
            )}
          </ul>
        </div>
      ) : parseFloat(formData.nominal_total) > 0 && (
        <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-center">
            ...
            <span className="text-green-700 text-sm">
              ✅ Pengeluaran sesuai dengan saldo tersedia
            </span>
          </div>
          <div className="mt-2 text-sm text-green-600 ml-7">
            <p>Setelah pengeluaran ini:</p>
            <ul className="mt-1 space-y-1">
              <li>• Saldo Syahriah: {formatCurrency((summaryData?.saldoSyahriah || 0) - (parseFloat(formData.nominal_syahriah) || 0))}</li>
              <li>• Saldo Donasi: {formatCurrency((summaryData?.saldoDonasi || 0) - (parseFloat(formData.nominal_donasi) || 0))}</li>
              <li>• Saldo Total: {formatCurrency((summaryData?.saldoAkhir || 0) - (parseFloat(formData.nominal_total) || 0))}</li>
            </ul>
          </div>
        </div>
      )}
